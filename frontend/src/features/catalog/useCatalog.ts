...
import { fetchBrands, fetchCategories, fetchProductBySlug, fetchProducts } from '../../api/catalogApi'
...
export function useProducts(query: ProductQuery) {
  ...
  const load = useCallback(
    (signal: AbortSignal) => fetchProducts({ page, size, category, brand, search, featured, sort }, signal),
