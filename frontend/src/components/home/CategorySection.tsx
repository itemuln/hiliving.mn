      ...
      <Container>
        ...
        <div className="mt-9 md:mt-12">
          {resource.status === 'loading' ? (
            <div
              aria-label="Ангилал ачаалж байна"
              role="status"
              className="grid grid-cols-3 gap-x-3 gap-y-7 md:grid-cols-9 md:gap-3"
            >
            ...
            <CatalogEmptyState
              compact
              title="Ангилал одоогоор байхгүй байна"
              description="Каталогийн ангилал нэмэгдэх үед энд харагдана."
            />
          )}
        </div>
      </Container>
