    ...
    <SectionReveal id="products" className="pb-14 pt-4 md:pb-20 md:pt-8">
      <Container>
        ...
        {resource.status === 'loading' ? (
          ...
          <div className="mt-8 md:mt-12"><CatalogErrorState compact onRetry={resource.retry} /></div>
        ) : products.length === 0 ? (
          <div className="mt-8 md:mt-12"><CatalogEmptyState compact title="Онцлох бүтээгдэхүүн одоогоор байхгүй байна" description="Шинэ бүтээгдэхүүн нэмэгдэх үед энд харагдана." /></div>
        ) : (
          <>
