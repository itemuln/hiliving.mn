...
- [x] Add a pre-JavaScript landing-page shell, remove the initial-path animation runtime in favor of native CSS/IntersectionObserver, and reduce the measured local initial JavaScript bundle without changing API ownership.
