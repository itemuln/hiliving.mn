...
- Responsive Mongolian-language admin shell with logo-only branding and linked dashboard counts, plus catalog CRUD, managed image upload, inventory, orders, users, banners, and news
