    ...
    public ApiResponse<AdminDashboardResponse> get() {
        return ApiResponse.of(
                new AdminDashboardResponse(
                        ...
                        products.countByStatus(ProductStatus.ARCHIVED),
                        categories.count(),
                        brands.count(),
                        users.count(),
                        banners.countByActiveTrue(),
                        news.countByPublishedTrue()));
    }
}
